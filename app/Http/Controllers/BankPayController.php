...
class BankPayController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->token_amount = ($request->deposit_value * $request->rate) / (Stage::findOrFail($request->stage)->fixed_price);
    ...
    public function confirm(Request $request)
    {
        ...
        $token_amount = ($request->deposit_value * $request->rate) / (Stage::findOrFail($request->stage_id)->fixed_price);
        try {
