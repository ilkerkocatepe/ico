<div class="main-menu menu-fixed @if(auth()->user()->theme == 'dark') menu-dark @else menu-light @endif menu-accordion menu-shadow" data-scroll-to-active="true">
                    ...
                    @else
                        ...
                        <li class="nav-item {{ \Route::currentRouteName() === $menu->route ? 'active' : '' }} {{ $custom_classes }}">
                            ...
                            @if(isset($menu->submenu))
                                @include('layouts.admin.submenu', ['menu' => $menu->submenu])
                            @endif
                        </li>
                    @endif
                @endforeach
