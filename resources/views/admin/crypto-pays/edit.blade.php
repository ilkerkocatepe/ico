                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <i class="fa fa-box fa-2x mr-1 mt-1 text-info"></i> <a class="badge badge-pill badge-glow badge-info font-medium-3 mb-2 p-1" href="{{ route('admin.stages.edit',$cryptoPay->stage_id) }}">{{ \App\Models\Stage::find($cryptoPay->stage_id)->name }}</a>
                                </div>
                                <div class="col-md-6 col-12">
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id=amount" class="form-control" name="amount" placeholder="{{ __('Amount') }}"  value="{{$cryptoPay->amount}}" required/>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="number" step="0.0001" class="form-control" id="price" name="price" placeholder="{{ __('Price') }}"  value="{{$cryptoPay->price}}" required/>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.0001" class="form-control" id="total" name="total" placeholder="{{ __('Total') }}" value="{{$cryptoPay->total}}" readonly/>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="user_note" class="form-control" name="user_note" placeholder="{{ __('User Note') }}" >{{$cryptoPay->user_note}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        <label for="admin_note">{{ __('Admin Note') }}</label>
                                        <textarea id="admin_note" class="form-control" name="admin_note" placeholder="{{ __('Admin Note') }}" >{{$cryptoPay->admin_note}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-md-4 col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @elseif($cryptoPay->status=="canceled")
                            @endif
                        </div>
                    </div>
                    @if($transaction!==null)
